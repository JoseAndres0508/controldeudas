...
/* =========================================================
   ...
   ========================================================= */
const TITLES = { inicio: 'Inicio', deudas: 'Ingresar deudas', cortes: 'Cortes', acreedores: 'Acreedores' };

export function showTab(name) {
  document.querySelectorAll('nav button').forEach(b => b.setAttribute('aria-selected', String(b.dataset.tab === name)));
  ['inicio', 'deudas', 'cortes', 'acreedores'].forEach(t => document.getElementById('tab-' + t).hidden = (t !== name));
